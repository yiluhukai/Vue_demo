        ...
        <form>
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    ...
                    <div class="form-group">
                        ...
                        <input
                                type="text"
                                id="email"
                                class="form-control" v-model.lazy="formData.mail">
                    </div>
                    <div class="form-group">
                        ...
                        <input
                                type="password"
                                id="password"
                                class="form-control" v-model.lazy="formData.password">
                    </div>
                    <div class="form-group">
                        ...
                        <input
                                type="number"
                                id="age"
                                class="form-control" v-model.lazy="formData.age">
                    </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
                    ...
                    <select
                            id="priority"
                            class="form-control" v-model="selectPriority">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                   <app-switch v-model="switchSelected"></app-switch>
                </div>
            </div>
            <hr>
            <div class="row">
